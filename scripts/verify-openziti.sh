...
run_passive_checks() {
    ...
    check_process gnb-ns "socat SCTP-LISTEN:38412" "gNB-side socat is listening for local NGAP SCTP"
    check_process core-ns "socat TCP-LISTEN:38413" "core-side socat is listening for decrypted NGAP TCP"
    ...
    check_service_definition "address: 127.0.0.1" "N2 host side is delivered to local core-side socat"
